...
urlpatterns = [
    ...
    path('cancel/<trip_name>/', trip_cancel_view, name="trip-cancel"),
    path('request/', trip_request_view, name="trip-request"),
    path('trip/<trip_name>', trip_detail_view, name="trip-detail"),
    path('feedback/<trip_name>', trip_feedback_view, name="trip-feedback"),
    path('driver/<trip_name>/', driver_action_view, name="trip-action"),
    path('calendar/', trips_calendar_view, name='calendar-view'),
