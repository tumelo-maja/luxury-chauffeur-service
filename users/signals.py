...
user_presave - Triggered before a User is saved. Ensures the username is always stored in lowercase.
user_postsave - Triggered after a User is saved. Creates a Profile for new users,
