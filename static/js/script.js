$(document).ready(function () {
    ...
    document.body.addEventListener("tripListChanged", function (e) {
        console.log("tripListChanged triggered");               // ✅ should show the full object
        console.log(e.detail);               // ✅ should show the full object
        console.log(e.detail.djangoMessages); // <-- this is where your messages live
    });
